...
<p>Welcome to <strong>Summit Trust Bank</strong> ("Summit Trust", "we", "our", "us"). This Privacy Policy explains how we collect, use, disclose, and safeguard your personal information when you use our website, mobile application, and financial services (collectively, the "Services").</p>
...
<p>To exercise these rights, contact <a href="mailto:privacy@Summit Trust.com">privacy@Summit Trust.com</a>.</p>
...
<h2>11. Contact Us</h2>
<p>For privacy inquiries: <a href="mailto:privacy@Summit Trust.com">privacy@Summit Trust.com</a><br>
Summit Trust Bank · Privacy Team · 123 Finance Street, Lagos, Nigeria.</p>
        `
    };
...
<p>By creating an account or using any feature of <strong>Summit Trust Bank</strong> ("Summit Trust", "we", "us"), you agree to be legally bound by these Terms of Service ("Terms"). If you do not agree, you may not use our Services.</p>
...
<p>You are responsible for maintaining the confidentiality of your credentials (password, PIN, recovery phrase). You must notify us immediately at <a href="mailto:security@Summit Trust.com">security@Summit Trust.com</a> if you suspect unauthorised access. Summit Trust is not liable for losses resulting from your failure to safeguard credentials.</p>
...
<p>These Terms are governed by the laws of Nigeria (or the jurisdiction in which Summit Trust Bank is registered) without regard to conflict-of-law principles.</p>
...
<h2>15. Contact</h2>
<p>Legal inquiries: <a href="mailto:legal@Summit Trust.com">legal@Summit Trust.com</a><br>
Summit Trust Bank · Legal Department · 123 Finance Street, Lagos, Nigeria.</p>
        `
    };
