...
const TxPage = (() => {
    ...
    async function downloadReceipt(txId) {
        ...
        try {
            ...
            doc.setFontSize(22);
            doc.text('Summit Trust Bank', 40, 36);
            ...
            doc.setFontSize(9);
            doc.setTextColor(255, 255, 255);
            doc.text('Summit Trust Bank  •  support@Summit Trust.com  •  Summit Trust.com', W / 2, pH - 16, { align: 'center' });
    ...
    async function exportStatement() {
        ...
        try {
            ...
            const addHeader = () => {
                ...
                doc.setFontSize(16);
                doc.setTextColor(255, 255, 255);
                doc.text('Summit Trust Bank  —  Transaction Statement', 30, 32);
                doc.setFont('helvetica', 'normal');
                doc.setFontSize(9);
